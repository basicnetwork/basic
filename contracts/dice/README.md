...
1. Player 1 proposes to bet 1 BASIC and submits SHA256(secret1)
2. Player 2 proposes to bet 1 BASIC and submits SHA256(secret2)
...
-------
1. Minners may exclude reveal transaction 
