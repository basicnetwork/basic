...
extern "C" {
    ...
    *
    *
    * A BASIC-CHAIN message has the following abstract structure:
    *
    * ```
    *   struct Message {
    ...
    * print(Name(code)); // Output: basic
    *
    * assert(Name(currentCode()) === "basic", "This message expects to be received by basic"); // Do nothing
